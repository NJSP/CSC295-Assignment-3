...
// File: Program.cs
/*
* A simple implementation of ArrayList ADT - Version 1.0
...
namespace MyArrayList
{
    internal class MyArrayListTest
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("An empty list is created, list count: " + list.Count);
    ...
    internal class MyArrayList<T> where T : IComparable<T>
    {
        ...
        public static void QuickSortHelper(T[] arr, int startIdx, int endIdx)
        {
            if (startIdx < endIdx) // if we have at least 2 elements in the "slice"
            {
                ...
                QuickSortHelper(arr, q + 1, endIdx); // sort the second "half"
            }
        }
